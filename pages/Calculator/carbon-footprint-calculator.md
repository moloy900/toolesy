...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What exactly is a carbon footprint?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A carbon footprint is the total amount of greenhouse gases (including carbon dioxide and methane) that are generated by our actions, measured in equivalent tons of CO₂."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Our calculator uses established emission factors from environmental agencies and research institutions. While it provides good estimates, individual circumstances may vary."
      }
    },
    {
      "@type": "Question",
      "name": "What's considered a 'good' carbon footprint?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The global average is about 4.8 tons per person annually. Climate scientists recommend reducing to 2 tons per person to meet Paris Agreement targets."
      }
    },
    {
      "@type": "Question",
      "name": "Do carbon offsets really work?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "High-quality, verified carbon offsets can effectively neutralize emissions, but reduction should always be prioritized over offsetting."
      }
    },
    {
      "@type": "Question",
      "name": "Which lifestyle change has the biggest impact?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Transportation (especially air travel and car usage) and diet (particularly reducing meat consumption) typically offer the largest reduction opportunities."
      }
    }
  ]
}
